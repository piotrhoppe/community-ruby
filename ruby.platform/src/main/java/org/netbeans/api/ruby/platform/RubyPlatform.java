...
//    private boolean indexInitialized;
    ...
    public boolean is24() {
        return getVersion() != null && getVersion().startsWith("2.4.");
    }

    public boolean is25() {
        return getVersion() != null && getVersion().startsWith("2.5.");
    }

    public boolean is26() {
        return getVersion() != null && getVersion().startsWith("2.6.");
    }

    public boolean is27() {
        return getVersion() != null && getVersion().startsWith("2.7.");
    }

    public boolean is30() {
        return getVersion() != null && getVersion().startsWith("3.0.");
    }
    public boolean is31() {
        return getVersion() != null && getVersion().startsWith("3.1.");
    }
    public boolean is32() {
        return getVersion() != null && getVersion().startsWith("3.2.");
    }
    public boolean is33() {
        return getVersion() != null && getVersion().startsWith("3.3.");
    }
    ...
    public synchronized static FileObject getRubyStubs() {
        if (stubsFO == null) {
            ...
            File clusterFile = InstalledFileLocator.getDefault().locate(
                    "modules/org-netbeans-modules-ruby-project.jar", "org.netbeans.modules.ruby.project", false); // NOI18N
...
//        Source.clearSourceCache();
    ...
    public static class Info {
        ...
        static Info forDefaultPlatform() {
            ...
            info.jversion = "1.7.3"; // NOI18N  // FIXME: Kill this embedding
            info.patchlevel = "385"; // NOI18N
            ...
            info.releaseDate = "2012-10-22"; // NOI18N
            info.platform = "java"; // NOI18N
            File jrubyHome = InstalledFileLocator.getDefault().locate("jruby", "org.jruby.distro", false);  // NOI18N
            ...
            info.libDir = FileUtil.toFile(libDirFO.getFileObject("/1.9")).getAbsolutePath(); // NOI18N
            info.gemHome = FileUtil.toFile(libDirFO.getFileObject("/gems/shared")).getAbsolutePath(); // NOI18N
            info.gemPath = info.gemHome;
            info.gemVersion = "1.8.24"; // NOI18N
            return info;
        }
        ...
        /**
         * Get version specific for the platform. E.g. in the case of JRuby it's version vs Ruby runtime version
         *
