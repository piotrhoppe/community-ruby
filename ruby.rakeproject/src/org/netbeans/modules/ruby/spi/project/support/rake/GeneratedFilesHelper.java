...
public final class GeneratedFilesHelper {
                    ...
                    dir.getFileSystem().runAtomicAction(new FileSystem.AtomicAction() {
                        ...
                        public void run() throws IOException {
                            ...
                            try {
                                ...
                                StreamSource projectXmlSource = new StreamSource(new ByteArrayInputStream(projectXmlData), Utilities.toURI(projectXmlF).toString());
    ...
    private static long checkFootprint(URL u) {
        ...
        if (u.getProtocol().equals("file")) { // NOI18N
            File f = Utilities.toFile(URI.create(u.toExternalForm()));
