...
import static org.jruby.nb.RubyEnumerator.enumeratorize;
import static org.jruby.nb.anno.FrameField.BACKREF;
import static org.jruby.nb.util.StringSupport.CR_7BIT;
import static org.jruby.nb.util.StringSupport.CR_BROKEN;
import static org.jruby.nb.util.StringSupport.CR_MASK;
import static org.jruby.nb.util.StringSupport.CR_UNKNOWN;
import static org.jruby.nb.util.StringSupport.CR_VALID;
import static org.jruby.nb.util.StringSupport.codeLength;
import static org.jruby.nb.util.StringSupport.codePoint;
import static org.jruby.nb.util.StringSupport.codeRangeScan;
import static org.jruby.nb.util.StringSupport.searchNonAscii;
import static org.jruby.nb.util.StringSupport.strLengthWithCodeRange;
import static org.jruby.nb.util.StringSupport.toLower;
import static org.jruby.nb.util.StringSupport.toUpper;
import static org.jruby.nb.util.StringSupport.unpackArg;
import static org.jruby.nb.util.StringSupport.unpackResult;
...
import static org.jruby.nb.runtime.Visibility.*;
import static org.jruby.nb.CompatVersion.*;
import org.jruby.nb.runtime.builtin.IRubyObject;
import org.jruby.nb.runtime.encoding.EncodingCapable;
import org.jruby.nb.runtime.marshal.UnmarshalStream;
import org.jruby.util.ByteList;
import org.jruby.nb.util.ConvertBytes;
import org.jruby.nb.util.MurmurHash;
import org.jruby.nb.util.Numeric;
import org.jruby.nb.util.Pack;
import org.jruby.nb.util.RegexpOptions;
import org.jruby.nb.util.Sprintf;
import org.jruby.nb.util.StringSupport;
import org.jruby.nb.util.TypeConverter;
import org.jruby.nb.util.string.JavaCrypt;

import static org.jruby.nb.javasupport.util.RuntimeHelpers.invokedynamic;
import static org.jruby.nb.runtime.MethodIndex.OP_EQUAL;
import static org.jruby.nb.runtime.MethodIndex.OP_CMP;
...
public class RubyString extends RubyObject implements EncodingCapable {
    ...
    */    
    ...
    /**
     * @see org.jruby.nb.util.Pack#unpack
     */
