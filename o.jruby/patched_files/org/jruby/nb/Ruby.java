...
import org.jruby.nb.util.func.Function1;
...
import org.jruby.nb.common.RubyWarnings;
...
import org.jruby.nb.compiler.JITCompiler;
...
import org.jruby.nb.ext.JRubyPOSIXHandler;
import org.jruby.nb.ext.LateLoadingLibrary;
import org.jruby.ext.posix.POSIX;
import org.jruby.ext.posix.POSIXFactory;
import org.jruby.nb.internal.runtime.GlobalVariables;
import org.jruby.nb.internal.runtime.ThreadService;
import org.jruby.nb.internal.runtime.ValueAccessor;
import org.jruby.nb.javasupport.JavaSupport;
import org.jruby.nb.management.ClassCache;
import org.jruby.nb.management.Config;
import org.jruby.nb.management.ParserStats;
import org.jruby.nb.parser.EvalStaticScope;
import org.jruby.nb.parser.Parser;
...
import org.jruby.nb.runtime.EventHook;
...
import org.jruby.nb.runtime.ObjectSpace;
import org.jruby.nb.runtime.RubyEvent;
import org.jruby.nb.runtime.ThreadContext;
import org.jruby.nb.runtime.builtin.IRubyObject;
import org.jruby.nb.runtime.encoding.EncodingService;
import org.jruby.nb.runtime.load.CompiledScriptLoader;
import org.jruby.nb.runtime.load.Library;
import org.jruby.nb.runtime.load.LoadService;
import org.jruby.nb.runtime.profile.IProfileData;
import org.jruby.nb.runtime.scope.ManyVarsDynamicScope;
import org.jruby.nb.util.BuiltinScript;
...
import org.jruby.nb.RubyInstanceConfig.CompileMode;
import org.jruby.nb.ast.RootNode;
import org.jruby.nb.ast.executable.RuntimeCache;
import org.jruby.nb.evaluator.ASTInterpreter;
import org.jruby.nb.exceptions.Unrescuable;
import org.jruby.nb.ext.coverage.CoverageData;
import org.jruby.nb.internal.runtime.methods.DynamicMethod;
import org.jruby.nb.javasupport.util.RuntimeHelpers;
import org.jruby.nb.management.BeanManager;
import org.jruby.nb.management.BeanManagerFactory;
import org.jruby.nb.platform.Platform;
import org.jruby.nb.runtime.ClassIndex;
import org.jruby.nb.runtime.MethodIndex;
import org.jruby.nb.runtime.load.BasicLibraryService;
import org.jruby.nb.threading.DaemonThreadFactory;
import org.jruby.nb.util.io.SelectorPool;
...
public final class Ruby {
     ...
     * @see org.jruby.nb.RubyInstanceConfig
     */
     ...
     *
     * This method is used by singleton model of org.jruby.nb.embed.ScriptingContainer
    ...
    private Ruby(RubyInstanceConfig config) {
        ...
        if(config.isSamplingEnabled()) {
            org.jruby.nb.util.SimpleSampler.registerThreadContext(threadService.getCurrentContext());
        }
	...
	this.hashSeed = this.random.nextInt();
        ...
        this.beanManager.register(new org.jruby.nb.management.Runtime(this));
     ...
     * 
     * @see org.jruby.nb.Ruby#setSaveLevel
     */
    ...
    */
    ...
    private void initBuiltins() {
        addLazyBuiltin("java.rb", "java", "org.jruby.nb.javasupport.Java");
        addLazyBuiltin("jruby.rb", "jruby", "org.jruby.nb.libraries.JRubyLibrary");
        addLazyBuiltin("jruby/ext.rb", "jruby/ext", "org.jruby.nb.ext.jruby.JRubyExtLibrary");
        addLazyBuiltin("jruby/util.rb", "jruby/util", "org.jruby.nb.ext.jruby.JRubyUtilLibrary");
        addLazyBuiltin("jruby/core_ext.rb", "jruby/core_ext", "org.jruby.nb.ext.jruby.JRubyCoreExtLibrary");
        addLazyBuiltin("jruby/type.rb", "jruby/type", "org.jruby.nb.ext.jruby.JRubyTypeLibrary");
        addLazyBuiltin("jruby/synchronized.rb", "jruby/synchronized", "org.jruby.nb.ext.jruby.JRubySynchronizedLibrary");
        addLazyBuiltin("iconv.jar", "iconv", "org.jruby.nb.libraries.IConvLibrary");
        addLazyBuiltin("nkf.jar", "nkf", "org.jruby.nb.libraries.NKFLibrary");
        addLazyBuiltin("stringio.jar", "stringio", "org.jruby.nb.libraries.StringIOLibrary");
        addLazyBuiltin("strscan.jar", "strscan", "org.jruby.nb.libraries.StringScannerLibrary");
        addLazyBuiltin("zlib.jar", "zlib", "org.jruby.nb.libraries.ZlibLibrary");
        addLazyBuiltin("enumerator.jar", "enumerator", "org.jruby.nb.libraries.EnumeratorLibrary");
        addLazyBuiltin("readline.jar", "readline", "org.jruby.nb.ext.ReadlineService");
        addLazyBuiltin("thread.jar", "thread", "org.jruby.nb.libraries.ThreadLibrary");
        addLazyBuiltin("thread.rb", "thread", "org.jruby.nb.libraries.ThreadLibrary");
        addLazyBuiltin("digest.jar", "digest.so", "org.jruby.nb.libraries.DigestLibrary");
        addLazyBuiltin("digest/md5.jar", "digest/md5", "org.jruby.nb.libraries.MD5");
        addLazyBuiltin("digest/rmd160.jar", "digest/rmd160", "org.jruby.nb.libraries.RMD160");
        addLazyBuiltin("digest/sha1.jar", "digest/sha1", "org.jruby.nb.libraries.SHA1");
        addLazyBuiltin("digest/sha2.jar", "digest/sha2", "org.jruby.nb.libraries.SHA2");
        addLazyBuiltin("bigdecimal.jar", "bigdecimal", "org.jruby.nb.libraries.BigDecimalLibrary");
        addLazyBuiltin("io/wait.jar", "io/wait", "org.jruby.nb.libraries.IOWaitLibrary");
        addLazyBuiltin("etc.jar", "etc", "org.jruby.nb.libraries.EtcLibrary");
        addLazyBuiltin("weakref.rb", "weakref", "org.jruby.nb.ext.WeakRefLibrary");
        addLazyBuiltin("delegate_internal.jar", "delegate_internal", "org.jruby.nb.ext.DelegateLibrary");
        addLazyBuiltin("timeout.rb", "timeout", "org.jruby.nb.ext.Timeout");
        addLazyBuiltin("socket.jar", "socket", "org.jruby.nb.ext.socket.SocketLibrary");
        addLazyBuiltin("rbconfig.rb", "rbconfig", "org.jruby.nb.libraries.RbConfigLibrary");
        addLazyBuiltin("jruby/serialization.rb", "serialization", "org.jruby.nb.libraries.JRubySerializationLibrary");
        addLazyBuiltin("ffi-internal.jar", "ffi-internal", "org.jruby.nb.ext.ffi.FFIService");
        addLazyBuiltin("tempfile.rb", "tempfile", "org.jruby.nb.libraries.TempfileLibrary");
        addLazyBuiltin("fcntl.rb", "fcntl", "org.jruby.nb.libraries.FcntlLibrary");
        addLazyBuiltin("yecht.jar", "yecht", "YechtService");

        if (is1_9()) {
            addLazyBuiltin("mathn/complex.jar", "mathn/complex", "org.jruby.nb.ext.mathn.Complex");
            addLazyBuiltin("mathn/rational.jar", "mathn/rational", "org.jruby.nb.ext.mathn.Rational");
            addLazyBuiltin("fiber.rb", "fiber", "org.jruby.nb.libraries.FiberExtLibrary");
            addLazyBuiltin("psych.jar", "psych", "org.jruby.nb.ext.psych.PsychLibrary");
            addLazyBuiltin("coverage.jar", "coverage", "org.jruby.nb.ext.coverage.CoverageLibrary");
        }

        if(RubyInstanceConfig.NATIVE_NET_PROTOCOL) {
            addLazyBuiltin("net/protocol.rb", "net/protocol", "org.jruby.nb.libraries.NetProtocolBufferedIOLibrary");
        }
        
        if (is1_9()) {
            if (RubyInstanceConfig.COROUTINE_FIBERS) {
                LoadService.reflectedLoad(this, "fiber", "org.jruby.nb.ext.fiber.CoroutineFiberLibrary", getJRubyClassLoader(), false);
            } else {
                LoadService.reflectedLoad(this, "fiber", "org.jruby.nb.ext.fiber.ThreadFiberLibrary", getJRubyClassLoader(), false);
            }
        }
    ...
    public PrintStream getErrorStream() {
        ...
        if(null != os) {
            ...
            return new PrintStream(new org.jruby.nb.util.SwallowingOutputStream());
        }*/
